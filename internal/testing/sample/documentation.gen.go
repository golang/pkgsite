...
<nav class="DocNav js-sideNav">
	<ul role="tree" aria-label="Outline">
		...
		<li class="DocNav-index" role="none">
				<a href="#pkg-index" class="DocNav-groupLabel js-docNav"
			...
			<li class="DocNav-functions" role="none">
				<a href="#pkg-functions" class="DocNav-groupLabel js-docNav"
			...
			<li class="DocNav-types" role="none">
				<a href="#pkg-types" class="DocNav-groupLabel js-docNav"
				...
				<ul role="group" id="nav-group-types">
						...
						<li role="none">
								...
								<a class="DocNav-groupLabel js-docNavType" href="#T" role="treeitem" aria-expanded="false" aria-level="2" data-aria-owns="nav.group.T" tabindex="-1">type T</a>
			...
			<li class="DocNav-notes" role="none">
				<a href="#pkg-notes" class="DocNav-groupLabel js-docNav"
...
<li><a href="#example-TF" class="js-exampleHref">TF</a></li>
	...
	<section class="Documentation-constants"><pre>
...
<p>const
	...
	<section class="Documentation-variables"><pre>
