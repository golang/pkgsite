...
func (r *reader) filterSpec(spec ast.Spec) bool {
	...
	case *ast.ImportSpec:
		...
		return true
	case *ast.ValueSpec:
		s.Values = filterExprList(s.Values, token۰IsExported, true)
	...
	case *ast.TypeSpec:
		if name := s.Name.Name; token۰IsExported(name) {
...
func (r *reader) filterDecl(decl ast.Decl) bool {
	...
	case *ast.FuncDecl:
		...
		return token۰IsExported(d.Name.Name)
	}
	return false
}
